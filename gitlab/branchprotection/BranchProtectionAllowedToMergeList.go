...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v15/branchprotection/internal"
...
// The jsii proxy struct for BranchProtectionAllowedToMergeList
type jsiiProxy_BranchProtectionAllowedToMergeList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_BranchProtectionAllowedToMergeList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_BranchProtectionAllowedToMergeList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_BranchProtectionAllowedToMergeList) InternalValue() interface{} {
...
func (j *jsiiProxy_BranchProtectionAllowedToMergeList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_BranchProtectionAllowedToMergeList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_BranchProtectionAllowedToMergeList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (b *jsiiProxy_BranchProtectionAllowedToMergeList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BranchProtectionAllowedToMergeList) ComputeFqn() *string {
	var returns *string
...
func (b *jsiiProxy_BranchProtectionAllowedToMergeList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (b *jsiiProxy_BranchProtectionAllowedToMergeList) ToString() *string {
	var returns *string
