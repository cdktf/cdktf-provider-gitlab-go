...
func (d *jsiiProxy_DataGitlabGroupSubgroupsSubgroupsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabGroupSubgroupsSubgroupsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
