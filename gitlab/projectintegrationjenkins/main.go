...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIntegrationJenkins)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "jenkinsUrl", GoGetter: "JenkinsUrl"},
			_jsii_.MemberProperty{JsiiProperty: "jenkinsUrlInput", GoGetter: "JenkinsUrlInput"},
			_jsii_.MemberProperty{JsiiProperty: "lifecycle", GoGetter: "Lifecycle"},
			_jsii_.MemberProperty{JsiiProperty: "mergeRequestEvents", GoGetter: "MergeRequestEvents"},
			_jsii_.MemberProperty{JsiiProperty: "mergeRequestEventsInput", GoGetter: "MergeRequestEventsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMergeRequestEvents", GoMethod: "ResetMergeRequestEvents"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectIntegrationJenkins.ProjectIntegrationJenkinsConfig",
		reflect.TypeOf((*ProjectIntegrationJenkinsConfig)(nil)).Elem(),
	)
}
