...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabProjectMembership.DataGitlabProjectMembershipConfig",
		reflect.TypeOf((*DataGitlabProjectMembershipConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabProjectMembership.DataGitlabProjectMembershipMembers",
