...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "forceRandomPassword", GoGetter: "ForceRandomPassword"},
			_jsii_.MemberProperty{JsiiProperty: "forceRandomPasswordInput", GoGetter: "ForceRandomPasswordInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetForceRandomPassword", GoMethod: "ResetForceRandomPassword"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.user.UserConfig",
