...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "excludeExternal", GoGetter: "ExcludeExternal"},
			_jsii_.MemberProperty{JsiiProperty: "excludeExternalInput", GoGetter: "ExcludeExternalInput"},
			_jsii_.MemberProperty{JsiiProperty: "excludeInternal", GoGetter: "ExcludeInternal"},
			_jsii_.MemberProperty{JsiiProperty: "excludeInternalInput", GoGetter: "ExcludeInternalInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "humans", GoGetter: "Humans"},
			_jsii_.MemberProperty{JsiiProperty: "humansInput", GoGetter: "HumansInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeExternal", GoMethod: "ResetExcludeExternal"},
			_jsii_.MemberMethod{JsiiMethod: "resetExcludeInternal", GoMethod: "ResetExcludeInternal"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetHumans", GoMethod: "ResetHumans"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetWithoutProjectBots", GoMethod: "ResetWithoutProjectBots"},
			...
			_jsii_.MemberProperty{JsiiProperty: "withoutProjectBots", GoGetter: "WithoutProjectBots"},
			_jsii_.MemberProperty{JsiiProperty: "withoutProjectBotsInput", GoGetter: "WithoutProjectBotsInput"},
		},
		func() interface{} {
