...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabclusteragent/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/data-sources/cluster_agent gitlab_cluster_agent}.
...
func (j *jsiiProxy_DataGitlabClusterAgent) Count() interface{} {
...
func (j *jsiiProxy_DataGitlabClusterAgent) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/data-sources/cluster_agent gitlab_cluster_agent} Data Source.
func NewDataGitlabClusterAgent(scope constructs.Construct, id *string, config *DataGitlabClusterAgentConfig) DataGitlabClusterAgent {
	...
	if err := validateNewDataGitlabClusterAgentParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabClusterAgent{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabClusterAgent.DataGitlabClusterAgent",
...
func (j *jsiiProxy_DataGitlabClusterAgent)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGitlabClusterAgent)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataGitlabClusterAgent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabClusterAgent_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabClusterAgent_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabClusterAgent_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabClusterAgent_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabClusterAgent_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabClusterAgent_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabClusterAgent_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabClusterAgent) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabClusterAgent) ToHclTerraform() interface{} {
	var returns interface{}
