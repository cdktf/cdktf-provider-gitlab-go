...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/projectvariable/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/project_variable gitlab_project_variable}.
...
func (j *jsiiProxy_ProjectVariable) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ProjectVariable) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_ProjectVariable) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/project_variable gitlab_project_variable} Resource.
func NewProjectVariable(scope constructs.Construct, id *string, config *ProjectVariableConfig) ProjectVariable {
	_init_.Initialize()

	if err := validateNewProjectVariableParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ProjectVariable{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.projectVariable.ProjectVariable",
...
func (j *jsiiProxy_ProjectVariable)SetCount(val interface{}) {
...
func (j *jsiiProxy_ProjectVariable)SetDescription(val *string) {
...
func ProjectVariable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProjectVariable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ProjectVariable_IsConstruct(x interface{}) *bool {
	...
	if err := validateProjectVariable_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectVariable_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectVariable_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectVariable_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectVariable_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProjectVariable) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProjectVariable) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProjectVariable) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProjectVariable) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectVariable) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProjectVariable) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectVariable) ResetDescription() {
	_jsii_.InvokeVoid(
		p,
		"resetDescription",
		nil, // no parameters
...
func (p *jsiiProxy_ProjectVariable) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProjectVariable) ToHclTerraform() interface{} {
	var returns interface{}
