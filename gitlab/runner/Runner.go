...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/runner/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/runner gitlab_runner}.
...
func (j *jsiiProxy_Runner) MaintenanceNote() *string {
	var returns *string
	_jsii_.Get(
		j,
		"maintenanceNote",
...
func (j *jsiiProxy_Runner) MaintenanceNoteInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/runner gitlab_runner} Resource.
...
func (j *jsiiProxy_Runner)SetMaintenanceNote(val *string) {
...
func Runner_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateRunner_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_Runner) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_Runner) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_Runner) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_Runner) MoveFromId(id *string) {
...
func (r *jsiiProxy_Runner) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_Runner) MoveToId(id *string) {
...
func (r *jsiiProxy_Runner) ResetMaintenanceNote() {
	_jsii_.InvokeVoid(
		r,
		"resetMaintenanceNote",
		nil, // no parameters
...
func (r *jsiiProxy_Runner) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_Runner) ToHclTerraform() interface{} {
	var returns interface{}
