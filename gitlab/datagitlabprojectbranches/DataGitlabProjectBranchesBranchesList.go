...
func (d *jsiiProxy_DataGitlabProjectBranchesBranchesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectBranchesBranchesList) Resolve(context cdktf.IResolveContext) interface{} {
