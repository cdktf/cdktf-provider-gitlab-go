...
func (b *jsiiProxy_BranchProtectionAllowedToMergeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BranchProtectionAllowedToMergeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
