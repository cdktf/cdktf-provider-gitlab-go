...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ServiceEmailsOnPush)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.serviceEmailsOnPush.ServiceEmailsOnPushConfig",
		reflect.TypeOf((*ServiceEmailsOnPushConfig)(nil)).Elem(),
	)
}
