...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabcurrentuser/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.8.0/docs/data-sources/current_user gitlab_current_user}.
...
func (j *jsiiProxy_DataGitlabCurrentUser) Count() interface{} {
...
func (j *jsiiProxy_DataGitlabCurrentUser) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.8.0/docs/data-sources/current_user gitlab_current_user} Data Source.
func NewDataGitlabCurrentUser(scope constructs.Construct, id *string, config *DataGitlabCurrentUserConfig) DataGitlabCurrentUser {
	...
	if err := validateNewDataGitlabCurrentUserParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabCurrentUser{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabCurrentUser.DataGitlabCurrentUser",
...
func (j *jsiiProxy_DataGitlabCurrentUser)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGitlabCurrentUser)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataGitlabCurrentUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabCurrentUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabCurrentUser_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabCurrentUser_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabCurrentUser_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabCurrentUser_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabCurrentUser_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabCurrentUser_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabCurrentUser) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabCurrentUser) ToHclTerraform() interface{} {
	var returns interface{}
