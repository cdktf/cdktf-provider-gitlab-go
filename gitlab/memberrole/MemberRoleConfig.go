...
type MemberRoleConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.3.0/docs/resources/member_role#base_access_level MemberRole#base_access_level}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.3.0/docs/resources/member_role#enabled_permissions MemberRole#enabled_permissions}
	EnabledPermissions *[]*string `field:"required" json:"enabledPermissions" yaml:"enabledPermissions"`
	// Name for the member role.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.3.0/docs/resources/member_role#name MemberRole#name}
	Name *string `field:"required" json:"name" yaml:"name"`
	// Description for the member role.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.3.0/docs/resources/member_role#description MemberRole#description}
	Description *string `field:"optional" json:"description" yaml:"description"`
	// Full path of the namespace to create the member role in. **Required for SAAS** **Not allowed for self-managed**.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.3.0/docs/resources/member_role#group_path MemberRole#group_path}
