...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIntegrationTelegram)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectIntegrationTelegram.ProjectIntegrationTelegramConfig",
		reflect.TypeOf((*ProjectIntegrationTelegramConfig)(nil)).Elem(),
	)
}
