...
// The jsii proxy struct for DataGitlabProjectMembershipMembersList
type jsiiProxy_DataGitlabProjectMembershipMembersList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataGitlabProjectMembershipMembersList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataGitlabProjectMembershipMembersList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGitlabProjectMembershipMembersList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGitlabProjectMembershipMembersList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataGitlabProjectMembershipMembersList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewDataGitlabProjectMembershipMembersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGitlabProjectMembershipMembersList {
	...
	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabProjectMembership.DataGitlabProjectMembershipMembersList",
...
func (d *jsiiProxy_DataGitlabProjectMembershipMembersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectMembershipMembersList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGitlabProjectMembershipMembersList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataGitlabProjectMembershipMembersList) ToString() *string {
	var returns *string
