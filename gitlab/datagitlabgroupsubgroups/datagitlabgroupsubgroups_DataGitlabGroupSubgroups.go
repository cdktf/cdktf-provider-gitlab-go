...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v5/datagitlabgroupsubgroups/internal"
...
func (j *jsiiProxy_DataGitlabGroupSubgroups) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataGitlabGroupSubgroups)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
