...
func (d *jsiiProxy_DataGitlabUserSshkeysKeysList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabUserSshkeysKeysList) Resolve(context cdktf.IResolveContext) interface{} {
