...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/user/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/user gitlab_user}.
type User interface {
...
func (j *jsiiProxy_User) CanCreateGroup() interface{} {
...
func (j *jsiiProxy_User) CanCreateGroupInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"canCreateGroupInput",
...
func (j *jsiiProxy_User) IsExternal() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isExternal",
...
func (j *jsiiProxy_User) IsExternalInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isExternalInput",
...
func (j *jsiiProxy_User) NamespaceId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"namespaceId",
...
func (j *jsiiProxy_User) NamespaceIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"namespaceIdInput",
...
func (j *jsiiProxy_User) Note() *string {
	var returns *string
	_jsii_.Get(
		j,
		"note",
...
func (j *jsiiProxy_User) NoteInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"noteInput",
...
func (j *jsiiProxy_User) ProjectsLimit() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"projectsLimit",
...
func (j *jsiiProxy_User) ProjectsLimitInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"projectsLimitInput",
...
func (j *jsiiProxy_User) SkipConfirmation() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipConfirmation",
...
func (j *jsiiProxy_User) SkipConfirmationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"skipConfirmationInput",
		&returns,
	)
	return returns
}
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/user gitlab_user} Resource.
func NewUser(scope constructs.Construct, id *string, config *UserConfig) User {
	...
	_jsii_.Create(
		"@cdktf/provider-gitlab.user.User",
...
func (j *jsiiProxy_User)SetCanCreateGroup(val interface{}) {
...
func (j *jsiiProxy_User)SetIsExternal(val interface{}) {
...
func (j *jsiiProxy_User)SetNamespaceId(val *float64) {
...
func (j *jsiiProxy_User)SetNote(val *string) {
...
func (j *jsiiProxy_User)SetProjectsLimit(val *float64) {
	if err := j.validateSetProjectsLimitParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_User)SetSkipConfirmation(val interface{}) {
	if err := j.validateSetSkipConfirmationParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (u *jsiiProxy_User) ResetCanCreateGroup() {
	_jsii_.InvokeVoid(
		u,
		"resetCanCreateGroup",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetIsExternal() {
	_jsii_.InvokeVoid(
		u,
		"resetIsExternal",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetNamespaceId() {
	_jsii_.InvokeVoid(
		u,
		"resetNamespaceId",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetNote() {
	_jsii_.InvokeVoid(
		u,
		"resetNote",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetProjectsLimit() {
	_jsii_.InvokeVoid(
		u,
		"resetProjectsLimit",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetSkipConfirmation() {
	_jsii_.InvokeVoid(
		u,
		"resetSkipConfirmation",
		nil, // no parameters
...
func (u *jsiiProxy_User) ResetTfPassword() {
	_jsii_.InvokeVoid(
		u,
		"resetTfPassword",
		nil, // no parameters
