...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIntegrationMicrosoftTeams)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectIntegrationMicrosoftTeams.ProjectIntegrationMicrosoftTeamsConfig",
		reflect.TypeOf((*ProjectIntegrationMicrosoftTeamsConfig)(nil)).Elem(),
	)
}
