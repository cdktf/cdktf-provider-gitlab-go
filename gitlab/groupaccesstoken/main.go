...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.groupAccessToken.GroupAccessTokenConfig",
		reflect.TypeOf((*GroupAccessTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.groupAccessToken.GroupAccessTokenRotationConfiguration",
		reflect.TypeOf((*GroupAccessTokenRotationConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.groupAccessToken.GroupAccessTokenRotationConfigurationOutputReference",
		reflect.TypeOf((*GroupAccessTokenRotationConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
