...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v15/datagitlabclusteragents/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.1/docs/data-sources/cluster_agents gitlab_cluster_agents}.
...
func (j *jsiiProxy_DataGitlabClusterAgents) Count() interface{} {
...
func (j *jsiiProxy_DataGitlabClusterAgents) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.1/docs/data-sources/cluster_agents gitlab_cluster_agents} Data Source.
func NewDataGitlabClusterAgents(scope constructs.Construct, id *string, config *DataGitlabClusterAgentsConfig) DataGitlabClusterAgents {
	...
	if err := validateNewDataGitlabClusterAgentsParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabClusterAgents{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabClusterAgents.DataGitlabClusterAgents",
...
func (j *jsiiProxy_DataGitlabClusterAgents)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGitlabClusterAgents)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataGitlabClusterAgents_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabClusterAgents_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabClusterAgents_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabClusterAgents_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabClusterAgents_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabClusterAgents_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabClusterAgents_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabClusterAgents_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabClusterAgents) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabClusterAgents) ToHclTerraform() interface{} {
	var returns interface{}
