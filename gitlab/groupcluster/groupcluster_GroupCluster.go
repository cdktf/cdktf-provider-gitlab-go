...
import (
	...
	"github.com/hashicorp/cdktf-provider-gitlab-go/gitlab/v3/groupcluster/internal"
...
func (j *jsiiProxy_GroupCluster) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_GroupCluster)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
