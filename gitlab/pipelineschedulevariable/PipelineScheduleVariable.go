...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/pipelineschedulevariable/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/pipeline_schedule_variable gitlab_pipeline_schedule_variable}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/pipeline_schedule_variable gitlab_pipeline_schedule_variable} Resource.
...
func PipelineScheduleVariable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePipelineScheduleVariable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PipelineScheduleVariable) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PipelineScheduleVariable) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PipelineScheduleVariable) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PipelineScheduleVariable) MoveFromId(id *string) {
...
func (p *jsiiProxy_PipelineScheduleVariable) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PipelineScheduleVariable) MoveToId(id *string) {
...
func (p *jsiiProxy_PipelineScheduleVariable) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PipelineScheduleVariable) ToHclTerraform() interface{} {
	var returns interface{}
