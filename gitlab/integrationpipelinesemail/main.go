...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationPipelinesEmail)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.integrationPipelinesEmail.IntegrationPipelinesEmailConfig",
		reflect.TypeOf((*IntegrationPipelinesEmailConfig)(nil)).Elem(),
	)
}
