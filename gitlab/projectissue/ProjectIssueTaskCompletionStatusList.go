...
func (p *jsiiProxy_ProjectIssueTaskCompletionStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProjectIssueTaskCompletionStatusList) Resolve(context cdktf.IResolveContext) interface{} {
