...
import (
	...
	"github.com/hashicorp/cdktf-provider-gitlab-go/gitlab/v3/project/internal"
...
func (j *jsiiProxy_Project) OperationsAccessLevel() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_Project) OperationsAccessLevelInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"operationsAccessLevelInput",
		&returns,
	)
	return returns
}
...
func (p *jsiiProxy_Project) ResetOperationsAccessLevel() {
	_jsii_.InvokeVoid(
		p,
		"resetOperationsAccessLevel",
		nil, // no parameters
