...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabreleaselinks/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/release_links gitlab_release_links}.
...
func (j *jsiiProxy_DataGitlabReleaseLinks) Count() interface{} {
...
func (j *jsiiProxy_DataGitlabReleaseLinks) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/release_links gitlab_release_links} Data Source.
func NewDataGitlabReleaseLinks(scope constructs.Construct, id *string, config *DataGitlabReleaseLinksConfig) DataGitlabReleaseLinks {
	...
	if err := validateNewDataGitlabReleaseLinksParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabReleaseLinks{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabReleaseLinks.DataGitlabReleaseLinks",
...
func (j *jsiiProxy_DataGitlabReleaseLinks)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGitlabReleaseLinks)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataGitlabReleaseLinks_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabReleaseLinks_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabReleaseLinks_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabReleaseLinks_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabReleaseLinks_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabReleaseLinks_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabReleaseLinks_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabReleaseLinks_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabReleaseLinks) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabReleaseLinks) ToHclTerraform() interface{} {
	var returns interface{}
