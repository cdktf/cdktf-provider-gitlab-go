...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/usercustomattribute/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_custom_attribute gitlab_user_custom_attribute}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_custom_attribute gitlab_user_custom_attribute} Resource.
...
func UserCustomAttribute_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateUserCustomAttribute_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (u *jsiiProxy_UserCustomAttribute) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_UserCustomAttribute) HasResourceMove() interface{} {
	var returns interface{}
...
func (u *jsiiProxy_UserCustomAttribute) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (u *jsiiProxy_UserCustomAttribute) MoveFromId(id *string) {
...
func (u *jsiiProxy_UserCustomAttribute) MoveTo(moveTarget *string, index interface{}) {
...
func (u *jsiiProxy_UserCustomAttribute) MoveToId(id *string) {
...
func (u *jsiiProxy_UserCustomAttribute) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (u *jsiiProxy_UserCustomAttribute) ToHclTerraform() interface{} {
	var returns interface{}
