...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/personalaccesstoken/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/personal_access_token gitlab_personal_access_token}.
...
func (j *jsiiProxy_PersonalAccessToken) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/personal_access_token gitlab_personal_access_token} Resource.
...
func (j *jsiiProxy_PersonalAccessToken)SetCount(val interface{}) {
...
func PersonalAccessToken_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePersonalAccessToken_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PersonalAccessToken) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PersonalAccessToken) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PersonalAccessToken) ToHclTerraform() interface{} {
	var returns interface{}
