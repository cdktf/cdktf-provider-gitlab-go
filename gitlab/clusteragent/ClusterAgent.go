...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/clusteragent/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/cluster_agent gitlab_cluster_agent}.
...
func (j *jsiiProxy_ClusterAgent) Connection() interface{} {
...
func (j *jsiiProxy_ClusterAgent) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ClusterAgent) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/cluster_agent gitlab_cluster_agent} Resource.
func NewClusterAgent(scope constructs.Construct, id *string, config *ClusterAgentConfig) ClusterAgent {
	...
	_jsii_.Create(
		"@cdktf/provider-gitlab.clusterAgent.ClusterAgent",
...
func ClusterAgent_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateClusterAgent_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ClusterAgent_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateClusterAgent_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ClusterAgent_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateClusterAgent_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (c *jsiiProxy_ClusterAgent) AddMoveTarget(moveTarget *string) {
...
func (c *jsiiProxy_ClusterAgent) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (c *jsiiProxy_ClusterAgent) ToHclTerraform() interface{} {
	var returns interface{}
