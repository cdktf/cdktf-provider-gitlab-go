...
func NewDataGitlabClusterAgentsClusterAgentsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGitlabClusterAgentsClusterAgentsList {
	...
	if err := validateNewDataGitlabClusterAgentsClusterAgentsListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGitlabClusterAgentsClusterAgentsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabClusterAgentsClusterAgentsList) Resolve(context cdktf.IResolveContext) interface{} {
