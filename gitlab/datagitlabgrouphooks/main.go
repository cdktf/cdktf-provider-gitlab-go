...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroupHooks.DataGitlabGroupHooksConfig",
		reflect.TypeOf((*DataGitlabGroupHooksConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroupHooks.DataGitlabGroupHooksHooks",
	...
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.dataGitlabGroupHooks.DataGitlabGroupHooksHooksOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "emojiEvents", GoGetter: "EmojiEvents"},
