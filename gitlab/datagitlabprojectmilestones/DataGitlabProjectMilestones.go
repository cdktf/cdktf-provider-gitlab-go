...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabprojectmilestones/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/project_milestones gitlab_project_milestones}.
...
func (j *jsiiProxy_DataGitlabProjectMilestones) Count() interface{} {
...
func (j *jsiiProxy_DataGitlabProjectMilestones) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/project_milestones gitlab_project_milestones} Data Source.
func NewDataGitlabProjectMilestones(scope constructs.Construct, id *string, config *DataGitlabProjectMilestonesConfig) DataGitlabProjectMilestones {
	...
	if err := validateNewDataGitlabProjectMilestonesParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabProjectMilestones{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabProjectMilestones.DataGitlabProjectMilestones",
...
func (j *jsiiProxy_DataGitlabProjectMilestones)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGitlabProjectMilestones)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataGitlabProjectMilestones)SetIncludeParentMilestones(val interface{}) {
	if err := j.validateSetIncludeParentMilestonesParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func DataGitlabProjectMilestones_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabProjectMilestones_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabProjectMilestones_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabProjectMilestones_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabProjectMilestones_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabProjectMilestones_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabProjectMilestones_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabProjectMilestones_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabProjectMilestones) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabProjectMilestones) ToHclTerraform() interface{} {
	var returns interface{}
