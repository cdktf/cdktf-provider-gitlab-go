...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/projectbadge/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/project_badge gitlab_project_badge}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/project_badge gitlab_project_badge} Resource.
func NewProjectBadge(scope constructs.Construct, id *string, config *ProjectBadgeConfig) ProjectBadge {
	...
	_jsii_.Create(
		"@cdktf/provider-gitlab.projectBadge.ProjectBadge",
...
func ProjectBadge_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProjectBadge_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func ProjectBadge_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectBadge_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectBadge_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectBadge_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProjectBadge) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProjectBadge) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProjectBadge) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProjectBadge) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectBadge) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProjectBadge) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectBadge) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProjectBadge) ToHclTerraform() interface{} {
	var returns interface{}
