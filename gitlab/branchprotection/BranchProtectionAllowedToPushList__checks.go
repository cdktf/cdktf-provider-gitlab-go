...
func (b *jsiiProxy_BranchProtectionAllowedToPushList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (b *jsiiProxy_BranchProtectionAllowedToPushList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
