...
func (d *jsiiProxy_DataGitlabProjectPushRulesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectPushRulesList) Resolve(context cdktf.IResolveContext) interface{} {
