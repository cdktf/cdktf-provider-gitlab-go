...
func (d *jsiiProxy_DataGitlabProjectTagsTagsReleaseList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGitlabProjectTagsTagsReleaseList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
