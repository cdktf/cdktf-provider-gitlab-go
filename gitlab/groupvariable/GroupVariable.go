...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/groupvariable/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/group_variable gitlab_group_variable}.
...
func (j *jsiiProxy_GroupVariable) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_GroupVariable) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/group_variable gitlab_group_variable} Resource.
...
func (j *jsiiProxy_GroupVariable)SetDescription(val *string) {
...
func GroupVariable_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateGroupVariable_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GroupVariable) AddMoveTarget(moveTarget *string) {
...
func (g *jsiiProxy_GroupVariable) HasResourceMove() interface{} {
	var returns interface{}
...
func (g *jsiiProxy_GroupVariable) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GroupVariable) MoveFromId(id *string) {
...
func (g *jsiiProxy_GroupVariable) MoveTo(moveTarget *string, index interface{}) {
...
func (g *jsiiProxy_GroupVariable) MoveToId(id *string) {
...
func (g *jsiiProxy_GroupVariable) ResetDescription() {
	_jsii_.InvokeVoid(
		g,
		"resetDescription",
		nil, // no parameters
...
func (g *jsiiProxy_GroupVariable) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (g *jsiiProxy_GroupVariable) ToHclTerraform() interface{} {
	var returns interface{}
