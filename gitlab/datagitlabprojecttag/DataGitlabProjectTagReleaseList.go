...
// The jsii proxy struct for DataGitlabProjectTagReleaseList
type jsiiProxy_DataGitlabProjectTagReleaseList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataGitlabProjectTagReleaseList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataGitlabProjectTagReleaseList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGitlabProjectTagReleaseList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGitlabProjectTagReleaseList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataGitlabProjectTagReleaseList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataGitlabProjectTagReleaseList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectTagReleaseList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGitlabProjectTagReleaseList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataGitlabProjectTagReleaseList) ToString() *string {
	var returns *string
