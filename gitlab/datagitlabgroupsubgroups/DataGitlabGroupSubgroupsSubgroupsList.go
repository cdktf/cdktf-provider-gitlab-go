...
func (d *jsiiProxy_DataGitlabGroupSubgroupsSubgroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabGroupSubgroupsSubgroupsList) Resolve(context cdktf.IResolveContext) interface{} {
