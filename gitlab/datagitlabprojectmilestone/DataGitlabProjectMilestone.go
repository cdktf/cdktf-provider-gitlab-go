...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabprojectmilestone/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/data-sources/project_milestone gitlab_project_milestone}.
...
func (j *jsiiProxy_DataGitlabProjectMilestone) Count() interface{} {
...
func (j *jsiiProxy_DataGitlabProjectMilestone) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/data-sources/project_milestone gitlab_project_milestone} Data Source.
func NewDataGitlabProjectMilestone(scope constructs.Construct, id *string, config *DataGitlabProjectMilestoneConfig) DataGitlabProjectMilestone {
	...
	if err := validateNewDataGitlabProjectMilestoneParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabProjectMilestone{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabProjectMilestone.DataGitlabProjectMilestone",
...
func (j *jsiiProxy_DataGitlabProjectMilestone)SetCount(val interface{}) {
...
func (j *jsiiProxy_DataGitlabProjectMilestone)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataGitlabProjectMilestone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabProjectMilestone_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabProjectMilestone_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabProjectMilestone_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabProjectMilestone_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabProjectMilestone_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabProjectMilestone_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabProjectMilestone_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabProjectMilestone) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabProjectMilestone) ToHclTerraform() interface{} {
	var returns interface{}
