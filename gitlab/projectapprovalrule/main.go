...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "disableImportingDefaultAnyApproverRuleOnCreate", GoGetter: "DisableImportingDefaultAnyApproverRuleOnCreate"},
			_jsii_.MemberProperty{JsiiProperty: "disableImportingDefaultAnyApproverRuleOnCreateInput", GoGetter: "DisableImportingDefaultAnyApproverRuleOnCreateInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectApprovalRule.ProjectApprovalRuleConfig",
