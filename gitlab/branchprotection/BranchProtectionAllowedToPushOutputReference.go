...
func (b *jsiiProxy_BranchProtectionAllowedToPushOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (b *jsiiProxy_BranchProtectionAllowedToPushOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
