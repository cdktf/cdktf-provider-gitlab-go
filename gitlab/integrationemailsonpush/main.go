...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationEmailsOnPush)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.integrationEmailsOnPush.IntegrationEmailsOnPushConfig",
		reflect.TypeOf((*IntegrationEmailsOnPushConfig)(nil)).Elem(),
	)
}
