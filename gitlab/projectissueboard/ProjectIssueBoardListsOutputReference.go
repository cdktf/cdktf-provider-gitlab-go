...
func (p *jsiiProxy_ProjectIssueBoardListsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProjectIssueBoardListsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
