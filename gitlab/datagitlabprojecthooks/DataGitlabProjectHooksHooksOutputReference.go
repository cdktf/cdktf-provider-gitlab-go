...
func (j *jsiiProxy_DataGitlabProjectHooksHooksOutputReference) CustomWebhookTemplate() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (d *jsiiProxy_DataGitlabProjectHooksHooksOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabProjectHooksHooksOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
