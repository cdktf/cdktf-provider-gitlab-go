...
// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/branch gitlab_branch}.
type Branch interface {
	...
	SetKeepOnDestroy(val interface{})
	KeepOnDestroyInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_Branch) KeepOnDestroy() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"keepOnDestroy",
...
func (j *jsiiProxy_Branch) KeepOnDestroyInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"keepOnDestroyInput",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/branch gitlab_branch} Resource.
...
func (j *jsiiProxy_Branch)SetKeepOnDestroy(val interface{}) {
	if err := j.validateSetKeepOnDestroyParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func Branch_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateBranch_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (b *jsiiProxy_Branch) AddMoveTarget(moveTarget *string) {
...
func (b *jsiiProxy_Branch) ResetKeepOnDestroy() {
	_jsii_.InvokeVoid(
		b,
		"resetKeepOnDestroy",
		nil, // no parameters
...
func (b *jsiiProxy_Branch) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (b *jsiiProxy_Branch) ToHclTerraform() interface{} {
	var returns interface{}
