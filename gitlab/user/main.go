...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "externalProvider", GoGetter: "ExternalProvider"},
			_jsii_.MemberProperty{JsiiProperty: "externalProviderInput", GoGetter: "ExternalProviderInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExternalProvider", GoMethod: "ResetExternalProvider"},
