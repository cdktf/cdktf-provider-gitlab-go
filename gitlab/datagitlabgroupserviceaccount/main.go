...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGitlabGroupServiceAccount)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroupServiceAccount.DataGitlabGroupServiceAccountConfig",
		reflect.TypeOf((*DataGitlabGroupServiceAccountConfig)(nil)).Elem(),
	)
}
