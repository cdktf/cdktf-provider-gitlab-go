...
func NewDataGitlabProjectMilestonesMilestonesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGitlabProjectMilestonesMilestonesOutputReference {
	...
	if err := validateNewDataGitlabProjectMilestonesMilestonesOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGitlabProjectMilestonesMilestonesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabProjectMilestonesMilestonesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
