...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectAccessToken.ProjectAccessTokenConfig",
		reflect.TypeOf((*ProjectAccessTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectAccessToken.ProjectAccessTokenRotationConfiguration",
		reflect.TypeOf((*ProjectAccessTokenRotationConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.projectAccessToken.ProjectAccessTokenRotationConfigurationOutputReference",
		reflect.TypeOf((*ProjectAccessTokenRotationConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
