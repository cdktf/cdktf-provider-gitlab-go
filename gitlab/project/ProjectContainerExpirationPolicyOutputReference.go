...
func (p *jsiiProxy_ProjectContainerExpirationPolicyOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProjectContainerExpirationPolicyOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
