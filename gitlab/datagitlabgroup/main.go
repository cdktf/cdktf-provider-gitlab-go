...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroup.DataGitlabGroupConfig",
		reflect.TypeOf((*DataGitlabGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroup.DataGitlabGroupSharedWithGroups",
		reflect.TypeOf((*DataGitlabGroupSharedWithGroups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.dataGitlabGroup.DataGitlabGroupSharedWithGroupsList",
		reflect.TypeOf((*DataGitlabGroupSharedWithGroupsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGitlabGroupSharedWithGroupsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
