...
func (d *jsiiProxy_DataGitlabBranchCommitList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabBranchCommitList) Resolve(context cdktf.IResolveContext) interface{} {
