...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/servicemicrosoftteams/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/service_microsoft_teams gitlab_service_microsoft_teams}.
...
func (j *jsiiProxy_ServiceMicrosoftTeams) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/service_microsoft_teams gitlab_service_microsoft_teams} Resource.
...
func (j *jsiiProxy_ServiceMicrosoftTeams)SetCount(val interface{}) {
...
func ServiceMicrosoftTeams_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateServiceMicrosoftTeams_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_ServiceMicrosoftTeams) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_ServiceMicrosoftTeams) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_ServiceMicrosoftTeams) ToHclTerraform() interface{} {
	var returns interface{}
