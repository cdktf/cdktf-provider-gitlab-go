...
func (d *jsiiProxy_DataGitlabProjectsProjectsSharedWithGroupsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectsProjectsSharedWithGroupsList) Resolve(context cdktf.IResolveContext) interface{} {
