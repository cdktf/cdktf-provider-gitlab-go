...
func NewDataGitlabClusterAgentsClusterAgentsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGitlabClusterAgentsClusterAgentsOutputReference {
	...
	if err := validateNewDataGitlabClusterAgentsClusterAgentsOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGitlabClusterAgentsClusterAgentsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabClusterAgentsClusterAgentsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
