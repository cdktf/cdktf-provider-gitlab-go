...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/usergpgkey/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_gpgkey gitlab_user_gpgkey}.
...
// The jsii proxy struct for UserGpgkey
type jsiiProxy_UserGpgkey struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_UserGpgkey) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_UserGpgkey) Connection() interface{} {
...
func (j *jsiiProxy_UserGpgkey) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_UserGpgkey) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_UserGpgkey) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserGpgkey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_UserGpgkey) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserGpgkey) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserGpgkey) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserGpgkey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_UserGpgkey) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_UserGpgkey) KeyId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"keyId",
...
func (j *jsiiProxy_UserGpgkey) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_UserGpgkey) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserGpgkey) Node() constructs.Node {
...
func (j *jsiiProxy_UserGpgkey) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_UserGpgkey) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_UserGpgkey) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_UserGpgkey) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_UserGpgkey) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserGpgkey) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserGpgkey) UserId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_UserGpgkey) UserIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"userIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_gpgkey gitlab_user_gpgkey} Resource.
func NewUserGpgkey(scope constructs.Construct, id *string, config *UserGpgkeyConfig) UserGpgkey {
	...
	_jsii_.Create(
		"@cdktf/provider-gitlab.userGpgkey.UserGpgkey",
...
func (j *jsiiProxy_UserGpgkey)SetKey(val *string) {
...
func (j *jsiiProxy_UserGpgkey)SetUserId(val *float64) {
...
func UserGpgkey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateUserGpgkey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func UserGpgkey_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUserGpgkey_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func UserGpgkey_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUserGpgkey_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (u *jsiiProxy_UserGpgkey) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_UserGpgkey) ResetId() {
	_jsii_.InvokeVoid(
		u,
		"resetId",
		nil, // no parameters
...
func (u *jsiiProxy_UserGpgkey) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UserGpgkey) ResetUserId() {
	_jsii_.InvokeVoid(
		u,
		"resetUserId",
		nil, // no parameters
...
func (u *jsiiProxy_UserGpgkey) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (u *jsiiProxy_UserGpgkey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (u *jsiiProxy_UserGpgkey) ToHclTerraform() interface{} {
	var returns interface{}
...
func (u *jsiiProxy_UserGpgkey) ToMetadata() interface{} {
	var returns interface{}
...
func (u *jsiiProxy_UserGpgkey) ToString() *string {
	var returns *string
...
func (u *jsiiProxy_UserGpgkey) ToTerraform() interface{} {
	var returns interface{}
