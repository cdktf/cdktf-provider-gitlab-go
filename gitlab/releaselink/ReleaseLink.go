...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/releaselink/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/release_link gitlab_release_link}.
...
func (j *jsiiProxy_ReleaseLink) Connection() interface{} {
...
func (j *jsiiProxy_ReleaseLink) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ReleaseLink) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/release_link gitlab_release_link} Resource.
func NewReleaseLink(scope constructs.Construct, id *string, config *ReleaseLinkConfig) ReleaseLink {
	_init_.Initialize()

	if err := validateNewReleaseLinkParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ReleaseLink)SetConnection(val interface{}) {
...
func (j *jsiiProxy_ReleaseLink)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ReleaseLink)SetProvisioners(val *[]interface{}) {
...
func ReleaseLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateReleaseLink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ReleaseLink_IsConstruct(x interface{}) *bool {
	...
	if err := validateReleaseLink_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (r *jsiiProxy_ReleaseLink) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_ReleaseLink) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_ReleaseLink) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_ReleaseLink) MoveFromId(id *string) {
...
func (r *jsiiProxy_ReleaseLink) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_ReleaseLink) MoveToId(id *string) {
...
func (r *jsiiProxy_ReleaseLink) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_ReleaseLink) ToHclTerraform() interface{} {
	var returns interface{}
