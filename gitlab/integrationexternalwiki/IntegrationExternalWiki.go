...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/integrationexternalwiki/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/integration_external_wiki gitlab_integration_external_wiki}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/integration_external_wiki gitlab_integration_external_wiki} Resource.
...
func IntegrationExternalWiki_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIntegrationExternalWiki_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IntegrationExternalWiki) AddMoveTarget(moveTarget *string) {
