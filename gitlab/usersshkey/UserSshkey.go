...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/usersshkey/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/user_sshkey gitlab_user_sshkey}.
...
// The jsii proxy struct for UserSshkey
type jsiiProxy_UserSshkey struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_UserSshkey) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_UserSshkey) Connection() interface{} {
...
func (j *jsiiProxy_UserSshkey) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_UserSshkey) CreatedAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createdAt",
...
func (j *jsiiProxy_UserSshkey) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_UserSshkey) ExpiresAt() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expiresAt",
...
func (j *jsiiProxy_UserSshkey) ExpiresAtInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expiresAtInput",
...
func (j *jsiiProxy_UserSshkey) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_UserSshkey) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserSshkey) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_UserSshkey) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_UserSshkey) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_UserSshkey) Key() *string {
	var returns *string
	_jsii_.Get(
		j,
		"key",
...
func (j *jsiiProxy_UserSshkey) KeyId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"keyId",
...
func (j *jsiiProxy_UserSshkey) KeyInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"keyInput",
...
func (j *jsiiProxy_UserSshkey) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_UserSshkey) Node() constructs.Node {
...
func (j *jsiiProxy_UserSshkey) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_UserSshkey) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_UserSshkey) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_UserSshkey) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_UserSshkey) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserSshkey) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_UserSshkey) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
func (j *jsiiProxy_UserSshkey) TitleInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"titleInput",
...
func (j *jsiiProxy_UserSshkey) UserId() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"userId",
...
func (j *jsiiProxy_UserSshkey) UserIdInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"userIdInput",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/user_sshkey gitlab_user_sshkey} Resource.
func NewUserSshkey(scope constructs.Construct, id *string, config *UserSshkeyConfig) UserSshkey {
	...
	_jsii_.Create(
		"@cdktf/provider-gitlab.userSshkey.UserSshkey",
...
func (j *jsiiProxy_UserSshkey)SetExpiresAt(val *string) {
...
func (j *jsiiProxy_UserSshkey)SetUserId(val *float64) {
...
func UserSshkey_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateUserSshkey_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func UserSshkey_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUserSshkey_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func UserSshkey_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateUserSshkey_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (u *jsiiProxy_UserSshkey) AddMoveTarget(moveTarget *string) {
...
func (u *jsiiProxy_UserSshkey) ResetExpiresAt() {
	_jsii_.InvokeVoid(
		u,
		"resetExpiresAt",
		nil, // no parameters
...
func (u *jsiiProxy_UserSshkey) ResetId() {
	_jsii_.InvokeVoid(
		u,
		"resetId",
		nil, // no parameters
...
func (u *jsiiProxy_UserSshkey) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		u,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (u *jsiiProxy_UserSshkey) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (u *jsiiProxy_UserSshkey) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (u *jsiiProxy_UserSshkey) ToHclTerraform() interface{} {
	var returns interface{}
...
func (u *jsiiProxy_UserSshkey) ToMetadata() interface{} {
	var returns interface{}
...
func (u *jsiiProxy_UserSshkey) ToString() *string {
	var returns *string
...
func (u *jsiiProxy_UserSshkey) ToTerraform() interface{} {
	var returns interface{}
