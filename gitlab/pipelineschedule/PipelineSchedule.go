...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v11/pipelineschedule/internal"
...
func (j *jsiiProxy_PipelineSchedule) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.1/docs/resources/pipeline_schedule gitlab_pipeline_schedule} Resource.
...
func (p *jsiiProxy_PipelineSchedule) ResetId() {
	_jsii_.InvokeVoid(
		p,
		"resetId",
		nil, // no parameters
