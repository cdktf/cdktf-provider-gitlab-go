...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GroupDependencyProxy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.groupDependencyProxy.GroupDependencyProxyConfig",
		reflect.TypeOf((*GroupDependencyProxyConfig)(nil)).Elem(),
	)
}
