...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationMicrosoftTeams)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.integrationMicrosoftTeams.IntegrationMicrosoftTeamsConfig",
		reflect.TypeOf((*IntegrationMicrosoftTeamsConfig)(nil)).Elem(),
	)
}
