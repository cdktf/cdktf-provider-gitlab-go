...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GlobalLevelNotifications)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.globalLevelNotifications.GlobalLevelNotificationsConfig",
		reflect.TypeOf((*GlobalLevelNotificationsConfig)(nil)).Elem(),
	)
}
