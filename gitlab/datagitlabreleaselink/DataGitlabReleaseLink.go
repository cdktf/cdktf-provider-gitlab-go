...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabreleaselink/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/release_link gitlab_release_link}.
...
func (j *jsiiProxy_DataGitlabReleaseLink) ForEach() cdktf.ITerraformIterator {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/release_link gitlab_release_link} Data Source.
func NewDataGitlabReleaseLink(scope constructs.Construct, id *string, config *DataGitlabReleaseLinkConfig) DataGitlabReleaseLink {
	...
	if err := validateNewDataGitlabReleaseLinkParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGitlabReleaseLink{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.dataGitlabReleaseLink.DataGitlabReleaseLink",
...
func (j *jsiiProxy_DataGitlabReleaseLink)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func DataGitlabReleaseLink_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabReleaseLink_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabReleaseLink_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabReleaseLink_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabReleaseLink_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabReleaseLink_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabReleaseLink_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabReleaseLink_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabReleaseLink) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabReleaseLink) ToHclTerraform() interface{} {
	var returns interface{}
