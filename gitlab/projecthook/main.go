...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourceAccessTokenEvents", GoMethod: "ResetResourceAccessTokenEvents"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceAccessTokenEvents", GoGetter: "ResourceAccessTokenEvents"},
			_jsii_.MemberProperty{JsiiProperty: "resourceAccessTokenEventsInput", GoGetter: "ResourceAccessTokenEventsInput"},
