...
// The jsii proxy struct for DataGitlabInstanceDeployKeysDeployKeysList
type jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (d *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataGitlabInstanceDeployKeysDeployKeysList) ToString() *string {
	var returns *string
