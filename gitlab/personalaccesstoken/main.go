...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.personalAccessToken.PersonalAccessTokenConfig",
		reflect.TypeOf((*PersonalAccessTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.personalAccessToken.PersonalAccessTokenRotationConfiguration",
		reflect.TypeOf((*PersonalAccessTokenRotationConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.personalAccessToken.PersonalAccessTokenRotationConfigurationOutputReference",
		reflect.TypeOf((*PersonalAccessTokenRotationConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
