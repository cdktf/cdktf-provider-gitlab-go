...
func (d *jsiiProxy_DataGitlabProjectHooksHooksList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGitlabProjectHooksHooksList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
