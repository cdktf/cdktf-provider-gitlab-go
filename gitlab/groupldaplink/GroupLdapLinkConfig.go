...
type GroupLdapLinkConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#group GroupLdapLink#group}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#group_access GroupLdapLink#group_access}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#ldap_provider GroupLdapLink#ldap_provider}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#cn GroupLdapLink#cn}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#filter GroupLdapLink#filter}
	Filter *string `field:"optional" json:"filter" yaml:"filter"`
	// If true, then delete and replace an existing LDAP link if one exists.
	//
	// Will also remove an LDAP link if the parent group is not found.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#force GroupLdapLink#force}
	Force interface{} `field:"optional" json:"force" yaml:"force"`
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#id GroupLdapLink#id}.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/resources/group_ldap_link#member_role_id GroupLdapLink#member_role_id}
