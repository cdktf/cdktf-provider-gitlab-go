...
func (r *jsiiProxy_ReleaseCommitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (r *jsiiProxy_ReleaseCommitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
