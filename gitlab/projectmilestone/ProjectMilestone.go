...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/projectmilestone/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/project_milestone gitlab_project_milestone}.
...
func (j *jsiiProxy_ProjectMilestone) Connection() interface{} {
...
func (j *jsiiProxy_ProjectMilestone) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_ProjectMilestone) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ProjectMilestone) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/project_milestone gitlab_project_milestone} Resource.
func NewProjectMilestone(scope constructs.Construct, id *string, config *ProjectMilestoneConfig) ProjectMilestone {
	_init_.Initialize()

	if err := validateNewProjectMilestoneParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ProjectMilestone{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.projectMilestone.ProjectMilestone",
...
func (j *jsiiProxy_ProjectMilestone)SetConnection(val interface{}) {
...
func (j *jsiiProxy_ProjectMilestone)SetCount(val interface{}) {
...
func (j *jsiiProxy_ProjectMilestone)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ProjectMilestone)SetProvisioners(val *[]interface{}) {
...
func ProjectMilestone_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProjectMilestone_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ProjectMilestone_IsConstruct(x interface{}) *bool {
	...
	if err := validateProjectMilestone_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectMilestone_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectMilestone_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectMilestone_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectMilestone_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProjectMilestone) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProjectMilestone) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProjectMilestone) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProjectMilestone) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectMilestone) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProjectMilestone) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectMilestone) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProjectMilestone) ToHclTerraform() interface{} {
	var returns interface{}
