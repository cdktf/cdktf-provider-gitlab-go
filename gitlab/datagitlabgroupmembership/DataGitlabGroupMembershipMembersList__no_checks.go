...
func (d *jsiiProxy_DataGitlabGroupMembershipMembersList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGitlabGroupMembershipMembersList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
