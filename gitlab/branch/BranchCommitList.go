...
func (b *jsiiProxy_BranchCommitList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BranchCommitList) Resolve(context cdktf.IResolveContext) interface{} {
