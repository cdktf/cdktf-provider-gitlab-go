...
func (d *jsiiProxy_DataGitlabUsersUsersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabUsersUsersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
