...
func (d *jsiiProxy_DataGitlabProjectMilestonesMilestonesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGitlabProjectMilestonesMilestonesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
