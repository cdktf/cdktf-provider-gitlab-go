...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/datagitlabprojecthook/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/project_hook gitlab_project_hook}.
...
func (j *jsiiProxy_DataGitlabProjectHook) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/project_hook gitlab_project_hook} Data Source.
func NewDataGitlabProjectHook(scope constructs.Construct, id *string, config *DataGitlabProjectHookConfig) DataGitlabProjectHook {
	...
	if err := validateNewDataGitlabProjectHookParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataGitlabProjectHook)SetCount(val interface{}) {
...
func DataGitlabProjectHook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabProjectHook_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabProjectHook_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabProjectHook_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabProjectHook_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabProjectHook_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabProjectHook_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabProjectHook_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabProjectHook) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabProjectHook) ToHclTerraform() interface{} {
	var returns interface{}
