...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectIntegrationPipelinesEmail)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectIntegrationPipelinesEmail.ProjectIntegrationPipelinesEmailConfig",
		reflect.TypeOf((*ProjectIntegrationPipelinesEmailConfig)(nil)).Elem(),
	)
}
