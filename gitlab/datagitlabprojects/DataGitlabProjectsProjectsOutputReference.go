...
func (j *jsiiProxy_DataGitlabProjectsProjectsOutputReference) EmailsEnabled() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"emailsEnabled",
...
func (d *jsiiProxy_DataGitlabProjectsProjectsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabProjectsProjectsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
