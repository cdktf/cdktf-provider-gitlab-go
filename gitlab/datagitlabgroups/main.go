...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGitlabGroups)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetTopLevelOnly", GoMethod: "ResetTopLevelOnly"},
			...
			_jsii_.MemberProperty{JsiiProperty: "topLevelOnly", GoGetter: "TopLevelOnly"},
			_jsii_.MemberProperty{JsiiProperty: "topLevelOnlyInput", GoGetter: "TopLevelOnlyInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroups.DataGitlabGroupsConfig",
		reflect.TypeOf((*DataGitlabGroupsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabGroups.DataGitlabGroupsGroups",
		reflect.TypeOf((*DataGitlabGroupsGroups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.dataGitlabGroups.DataGitlabGroupsGroupsList",
		reflect.TypeOf((*DataGitlabGroupsGroupsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGitlabGroupsGroupsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
