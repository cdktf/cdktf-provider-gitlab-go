...
func (d *jsiiProxy_DataGitlabProjectsProjectsPermissionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGitlabProjectsProjectsPermissionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
