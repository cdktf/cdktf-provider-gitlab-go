...
func NewDataGitlabProjectTagsTagsCommitOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) DataGitlabProjectTagsTagsCommitOutputReference {
	...
	if err := validateNewDataGitlabProjectTagsTagsCommitOutputReferenceParameters(terraformResource, terraformAttribute, complexObjectIndex, complexObjectIsFromSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGitlabProjectTagsTagsCommitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataGitlabProjectTagsTagsCommitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
