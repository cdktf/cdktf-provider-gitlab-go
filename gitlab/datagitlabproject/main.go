...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "ciIdTokenSubClaimComponentsInput", GoGetter: "CiIdTokenSubClaimComponentsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCiIdTokenSubClaimComponents", GoMethod: "ResetCiIdTokenSubClaimComponents"},
