...
func NewDataGitlabReleaseLinksReleaseLinksList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGitlabReleaseLinksReleaseLinksList {
	...
	if err := validateNewDataGitlabReleaseLinksReleaseLinksListParameters(terraformResource, terraformAttribute, wrapsSet); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataGitlabReleaseLinksReleaseLinksList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabReleaseLinksReleaseLinksList) Resolve(context cdktf.IResolveContext) interface{} {
