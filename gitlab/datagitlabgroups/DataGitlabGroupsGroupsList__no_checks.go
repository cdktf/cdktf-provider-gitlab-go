...
func (d *jsiiProxy_DataGitlabGroupsGroupsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataGitlabGroupsGroupsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
