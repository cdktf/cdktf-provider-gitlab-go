...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/integrationemailsonpush/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/integration_emails_on_push gitlab_integration_emails_on_push}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/integration_emails_on_push gitlab_integration_emails_on_push} Resource.
...
func IntegrationEmailsOnPush_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateIntegrationEmailsOnPush_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (i *jsiiProxy_IntegrationEmailsOnPush) AddMoveTarget(moveTarget *string) {
...
func (i *jsiiProxy_IntegrationEmailsOnPush) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (i *jsiiProxy_IntegrationEmailsOnPush) ToHclTerraform() interface{} {
	var returns interface{}
