...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/projectsharegroup/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/project_share_group gitlab_project_share_group}.
...
func (j *jsiiProxy_ProjectShareGroup) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/project_share_group gitlab_project_share_group} Resource.
func NewProjectShareGroup(scope constructs.Construct, id *string, config *ProjectShareGroupConfig) ProjectShareGroup {
	_init_.Initialize()

	if err := validateNewProjectShareGroupParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_ProjectShareGroup{}

	_jsii_.Create(
		"@cdktf/provider-gitlab.projectShareGroup.ProjectShareGroup",
...
func (j *jsiiProxy_ProjectShareGroup)SetCount(val interface{}) {
...
func ProjectShareGroup_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProjectShareGroup_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ProjectShareGroup_IsConstruct(x interface{}) *bool {
	...
	if err := validateProjectShareGroup_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectShareGroup_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectShareGroup_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectShareGroup_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectShareGroup_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProjectShareGroup) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProjectShareGroup) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProjectShareGroup) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProjectShareGroup) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectShareGroup) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProjectShareGroup) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectShareGroup) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProjectShareGroup) ToHclTerraform() interface{} {
	var returns interface{}
