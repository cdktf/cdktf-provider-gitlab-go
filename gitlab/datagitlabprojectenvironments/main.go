...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataGitlabProjectEnvironments)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetStates", GoMethod: "ResetStates"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabProjectEnvironments.DataGitlabProjectEnvironmentsConfig",
		reflect.TypeOf((*DataGitlabProjectEnvironmentsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.dataGitlabProjectEnvironments.DataGitlabProjectEnvironmentsEnvironments",
		reflect.TypeOf((*DataGitlabProjectEnvironmentsEnvironments)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-gitlab.dataGitlabProjectEnvironments.DataGitlabProjectEnvironmentsEnvironmentsList",
		reflect.TypeOf((*DataGitlabProjectEnvironmentsEnvironmentsList)(nil)).Elem(),
		[]_jsii_.Member{
