...
func (d *jsiiProxy_DataGitlabProjectBranchesBranchesCommitList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectBranchesBranchesCommitList) Resolve(context cdktf.IResolveContext) interface{} {
