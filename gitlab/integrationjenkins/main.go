...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IntegrationJenkins)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.integrationJenkins.IntegrationJenkinsConfig",
		reflect.TypeOf((*IntegrationJenkinsConfig)(nil)).Elem(),
	)
}
