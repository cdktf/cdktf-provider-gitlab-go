...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/datagitlabuser/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.9.1/docs/data-sources/user gitlab_user}.
...
func (j *jsiiProxy_DataGitlabUser) Count() interface{} {
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.9.1/docs/data-sources/user gitlab_user} Data Source.
func NewDataGitlabUser(scope constructs.Construct, id *string, config *DataGitlabUserConfig) DataGitlabUser {
	_init_.Initialize()

	if err := validateNewDataGitlabUserParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_DataGitlabUser)SetCount(val interface{}) {
...
func DataGitlabUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataGitlabUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func DataGitlabUser_IsConstruct(x interface{}) *bool {
	...
	if err := validateDataGitlabUser_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabUser_IsTerraformDataSource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabUser_IsTerraformDataSourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func DataGitlabUser_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateDataGitlabUser_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DataGitlabUser) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataGitlabUser) ToHclTerraform() interface{} {
	var returns interface{}
