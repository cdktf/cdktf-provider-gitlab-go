...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ProjectDeployToken)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.projectDeployToken.ProjectDeployTokenConfig",
		reflect.TypeOf((*ProjectDeployTokenConfig)(nil)).Elem(),
	)
}
