...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/projectcluster/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/project_cluster gitlab_project_cluster}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/project_cluster gitlab_project_cluster} Resource.
...
func (p *jsiiProxy_ProjectCluster) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProjectCluster) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectCluster) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectCluster) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProjectCluster) ToHclTerraform() interface{} {
	var returns interface{}
