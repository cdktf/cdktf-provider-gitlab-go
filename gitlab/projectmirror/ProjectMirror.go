...
import (
	...
	"github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/projectmirror/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/project_mirror gitlab_project_mirror}.
...
// Create a new {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/project_mirror gitlab_project_mirror} Resource.
func NewProjectMirror(scope constructs.Construct, id *string, config *ProjectMirrorConfig) ProjectMirror {
	_init_.Initialize()

	if err := validateNewProjectMirrorParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_ProjectMirror)SetKeepDivergentRefs(val interface{}) {
	if err := j.validateSetKeepDivergentRefsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func ProjectMirror_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProjectMirror_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func ProjectMirror_IsConstruct(x interface{}) *bool {
	...
	if err := validateProjectMirror_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectMirror_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectMirror_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ProjectMirror_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateProjectMirror_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (p *jsiiProxy_ProjectMirror) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProjectMirror) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProjectMirror) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProjectMirror) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProjectMirror) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProjectMirror) MoveToId(id *string) {
...
func (p *jsiiProxy_ProjectMirror) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProjectMirror) ToHclTerraform() interface{} {
	var returns interface{}
