...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*UserImpersonationToken)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "impersonation", GoGetter: "Impersonation"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-gitlab.userImpersonationToken.UserImpersonationTokenConfig",
		reflect.TypeOf((*UserImpersonationTokenConfig)(nil)).Elem(),
	)
}
