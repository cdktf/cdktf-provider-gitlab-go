...
func (b *jsiiProxy_BranchProtectionAllowedToPushList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BranchProtectionAllowedToPushList) Resolve(context cdktf.IResolveContext) interface{} {
