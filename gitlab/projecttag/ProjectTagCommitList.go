...
// The jsii proxy struct for ProjectTagCommitList
type jsiiProxy_ProjectTagCommitList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ProjectTagCommitList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ProjectTagCommitList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ProjectTagCommitList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ProjectTagCommitList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ProjectTagCommitList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (p *jsiiProxy_ProjectTagCommitList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProjectTagCommitList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_ProjectTagCommitList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (p *jsiiProxy_ProjectTagCommitList) ToString() *string {
	var returns *string
