...
func (d *jsiiProxy_DataGitlabProjectIssueTaskCompletionStatusList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGitlabProjectIssueTaskCompletionStatusList) Resolve(context cdktf.IResolveContext) interface{} {
